...
static const struct sensor_reg ov5640_init_tbl[] = {
		{0x3008, 0x42},
		{0x3103, 0x03},
		{0x3017, 0x00},
		{0x3018, 0x00},
...
static const struct sensor_reg ov5640_preview_tbl[] = {
...
static const struct sensor_reg ov5640_vga_preview[] =
{
...
static const struct sensor_reg OV5640_RGB_QVGA[] =
{
		{0x3008, 0x02},
		{0x3035, 0x41},
		{0x4740, 0x21},
...
//2592x1944 QSXGA
static const struct sensor_reg OV5640_JPEG_QSXGA[] =
{
		{0x3820 ,0x40},
		{0x3821 ,0x26},
		{0x3814 ,0x11},
...
//5MP
static const struct sensor_reg OV5640_5MP_JPEG[] =
{
		{0x3800 ,0x00},
		{0x3801 ,0x00},
		{0x3802 ,0x00},
...
//320x240 QVGA
static const struct sensor_reg OV5640_QSXGA2QVGA[] =
{
		{0x3800 ,0x00},
		{0x3801 ,0x00},
		{0x3802 ,0x00},
...
//640x480 VGA
static const struct sensor_reg OV5640_QSXGA2VGA[] =
{
		{0x3800 ,0x00},
		{0x3801 ,0x00},
		{0x3802 ,0x00},
...
//800x480 WVGA
static const struct sensor_reg OV5640_QSXGA2WVGA[] =
{
		{0x3800 ,0x00},
		{0x3801 ,0x00},
		{0x3802 ,0x00},
...
//352x288 CIF
static const struct sensor_reg OV5640_QSXGA2CIF[] =
{
		{0x3800 ,0x00},
		{0x3801 ,0x00},
		{0x3802 ,0x00},
...
//1280x960 SXGA
static const struct sensor_reg OV5640_QSXGA2SXGA[] =
{
		{0x3800 ,0x00},
		{0x3801 ,0x00},
		{0x3802 ,0x00},
...
//2048x1536 QXGA
static const struct sensor_reg OV5640_QSXGA2QXGA[] =
{
		{0x3800 ,0x00},
		{0x3801 ,0x00},
		{0x3802 ,0x00},
...
//1600x1200 UXGA
static const struct sensor_reg OV5640_QSXGA2UXGA[] =
{
		{0x3800 ,0x00},
		{0x3801 ,0x00},
		{0x3802 ,0x00},
...
//1024x768 XGA
static const struct sensor_reg OV5640_QSXGA2XGA[] =
{
		{0x3800 ,0x00},
		{0x3801 ,0x00},
		{0x3802 ,0x00},
